...
def downsample_dataset(dataset_filename : str, downsample_factor):
    full_keyset = np.fromfile("../data/" + dataset_filename, dtype=np.uint64)[1:]
    ...
    with open("../data/" + dataset_filename + "_1M_uint64", "wb") as output_file:
...
#downsample_dataset("wiki_ts_200M_uint64", 100000)
downsample_dataset("fb_200M_uint64", 100000)
